...
if (User::isLoggedIn()) {
    ...
    foreach ($chars as $char) {
        ...
        if ($seconds > 0) {
            $pageRefresh = min($pageRefresh, $char["cachedUntilSeconds"]);
        }
    }
...
$app->render(
  "index.html",
  array("pageTitle" => "Home", "chars" => $chars, "pageRefresh" => $pageRefresh, "config" => $config)
);
